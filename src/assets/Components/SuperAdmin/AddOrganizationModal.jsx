...
function AddOrganizationModal({ isOpen, onClose }) {
  ...
  const handleSubmit = () => {
    ...
    // backend call goes here once SuperAdminController is ready
  };

  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-[#161922] border border-white/[0.06] rounded-[14px] w-[480px] max-w-full max-h-[90vh] overflow-y-auto shadow-[0_8px_40px_rgba(0,0,0,0.35)]">
        ...
        <div className="px-7 py-6 flex flex-col gap-5">
          ...
          <p className="text-xs font-semibold text-[#f0a83b] uppercase tracking-wide mt-2">
            First Admin Account
          </p>
