              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[13.5px] text-[#c7c9d1] leading-snug">
                      Assigned a new project to the development team.
                    </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[13.5px] text-[#c7c9d1] leading-snug">
                      Reviewed bugs reported for E-Commerce Platform.
                    </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[13.5px] text-[#c7c9d1] leading-snug">
                      Added a new member to the project team.
                    </p>
